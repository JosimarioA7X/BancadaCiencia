...
<h2>${item.titulo}</h2>
  ...
  <div style="margin-top: 20px; display: flex; gap: 10px; flex-wrap: wrap;">
    ...
    ${ePDF ? `
      <a href="${caminhoArquivo}" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 6px; padding: 10px 18px; background: #A855F7; color: #ffffff; font-weight: bold; border-radius: 8px; text-decoration: none;">
        👁️ Visualizar PDF
      </a>
    ` : ''}
  </div>
